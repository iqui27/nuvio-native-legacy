...
cc ${flags[@]+"${flags[@]}"} src/artehero.c src/artefontes.c src/js.c tests/artehero.c \
...
cc ${flags[@]+"${flags[@]}"} -D__EMSCRIPTEN__ src/artehero.c src/artefontes.c src/js.c tests/artehero.c \
