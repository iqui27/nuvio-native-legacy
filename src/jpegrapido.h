...
// A partir de bytes ja na memoria. Tizen: JPEG, PNG e WebP; NULL para GIF e o
// resto. LG: so JPEG (fmemopen), NULL no resto — quem chama tenta os outros
// leitores. Ver a nota em jpegrapido.c.
#include <stddef.h>
